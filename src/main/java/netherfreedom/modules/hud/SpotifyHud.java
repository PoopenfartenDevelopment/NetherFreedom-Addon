...
import netherfreedom.utils.SpotifyService;
...
public class SpotifyHud extends HudElement {
    public static final HudElementInfo<SpotifyHud> INFO = new HudElementInfo<>(NetherFreedom.HUD, "spotify-HUD", "Display the current song playing in spotify.", SpotifyHud::new);
