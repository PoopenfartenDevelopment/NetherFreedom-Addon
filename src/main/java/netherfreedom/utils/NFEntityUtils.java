...
public class NFEntityUtils {
    ...
    public static BlockPos getCityBlock(PlayerEntity player) {
        ...
        posList.sort(Comparator.comparingDouble(NFPlayerUtils::distanceFromEye));
    ...
    public static BlockPos playerPos(PlayerEntity targetEntity) {
        return NFWorldUtils.roundBlockPos(targetEntity.getPos());
    }
    ...
    public static boolean isBurrowed(PlayerEntity targetEntity, BlastResistantType type) {
        BlockPos playerPos = NFWorldUtils.roundBlockPos(new Vec3d(targetEntity.getX(), targetEntity.getY() + 0.4, targetEntity.getZ()));
    ...
    public static boolean isWebbed(PlayerEntity targetEntity) {
        return NFWorldUtils.doesBoxTouchBlock(targetEntity.getBoundingBox(), Blocks.COBWEB);
    }
